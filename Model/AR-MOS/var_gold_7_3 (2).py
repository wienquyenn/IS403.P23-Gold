...
Original file is located at
    https://colab.research.google.com/drive/1fHJ_ObBRJnhHpRgWpgh-HNYs1Vu9qoeb
...
forecast_periods = {"30 ngày": 30, "60 ngày": 60, "90 ngày": 90}
forecasts = {}
...
# Vẽ dự đoán tập kiểm tra
plt.plot(test_df.index, test_df["pred_Price"], label="Dự đoán trên tập kiểm tra", color='green', linestyle='--', linewidth=2)

# Vẽ dự đoán 30, 60, 90 ngày tới
colors = ['purple', 'brown', 'pink']
for color, key in zip(colors, ["30 ngày", "60 ngày", "90 ngày"]):
    plt.plot(forecasts[key]["ds"], forecasts[key]["pred"], label=f'Dự đoán {key} tới', color=color, linestyle='--')
